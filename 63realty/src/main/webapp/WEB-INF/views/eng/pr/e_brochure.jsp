...
<title>e-브로셔 | Hanwha 63 City</title>
</head>
<body>
<%@ include file="/WEB-INF/views/eng/inc/header.jsp"%>
<div class="location">
	<div class="path"><img src="/resources/eng/img/ico_home.png" alt="" /> Home &gt; 홍보센터 &gt; <strong>e-브로셔</strong></div>
</div>
<div class="container_in">
	<%@ include file="/WEB-INF/views/eng/inc/lnb_pr.jsp"%>
	<div id="contents" class="contents">
		<div class="title_box"><h2>e-브로셔</h2></div>
		<h3 class="ac"><img src="/resources/eng/img/hanwha_txt.gif" alt="HIGHEST &amp; BEST USE OF REALTY Hanwha 63 City" /></h3>
		...
		<div class="btn_right">
			<a href="https://get.adobe.com/kr/reader/" target="_blank"><img src="/resources/eng/img/btn_viewer.gif" alt="뷰어 다운로드" /></a>
		</div>
	</div>
</div>
