	...
	<div id="contents" class="contents">
		...
		<dl class="board_nav">
			...
			<c:choose>
				...
				<c:otherwise>
					<dd><a href="javascript:;" onclick="goBoardView('/pr/office_view/${preNext.nextMainBoardSeq}');">${preNext.nextTitle}</a></dd>
				</c:otherwise>			
			</c:choose>
		</dl>		
		<dl class="board_nav">		
			...
			<c:choose>
				...
				<c:otherwise>
					<dd><a href="javascript:;" onclick="goBoardView('/pr/office_view/${preNext.preMainBoardSeq}');">${preNext.preTitle}</a></dd>					
				</c:otherwise>
			</c:choose>
		</dl>
		<!-- //다음글, 이전글 -->
		...
		<div class="btn_right">
			<a href="/pr/office_list" class="btn_m1">목록</a>
		</div>
	</div>
</div>
